...
D3D12_RESOURCE_STATES ResStateTypeToD3D12(Mox::RESOURCE_STATE InResState)
{
	switch (InResState)
	{
	case Mox::RESOURCE_STATE::NEUTRAL: return D3D12_RESOURCE_STATE_COMMON;
...
DXGI_FORMAT BufferFormatToD3D12(Mox::BUFFER_FORMAT InFormat)
{
	...
	case Mox::BUFFER_FORMAT::R32G32_FLOAT: return DXGI_FORMAT_R32G32_FLOAT;
	case Mox::BUFFER_FORMAT::R8G8B8A8_UNORM: return DXGI_FORMAT_R8G8B8A8_UNORM;
	case Mox::BUFFER_FORMAT::B8G8R8A8_UNORM: return DXGI_FORMAT_B8G8R8A8_UNORM;
	...
	case Mox::BUFFER_FORMAT::BC2_UNORM: return DXGI_FORMAT_BC2_UNORM;
	case Mox::BUFFER_FORMAT::BC7_UNORM: return DXGI_FORMAT_BC7_UNORM;
...
Mox::BUFFER_FORMAT BufferFormatToEngine(DXGI_FORMAT InFormat)
{
	...
	case DXGI_FORMAT_R32G32_FLOAT: return Mox::BUFFER_FORMAT::R32G32_FLOAT;
	case DXGI_FORMAT_R8G8B8A8_UNORM: return Mox::BUFFER_FORMAT::R8G8B8A8_UNORM;
	case DXGI_FORMAT_B8G8R8A8_UNORM: return Mox::BUFFER_FORMAT::B8G8R8A8_UNORM;
	...
	case DXGI_FORMAT_BC2_UNORM: return Mox::BUFFER_FORMAT::BC2_UNORM;
	case DXGI_FORMAT_BC7_UNORM: return Mox::BUFFER_FORMAT::BC7_UNORM;
	default: StopForFail("DXGI Buffer Format undefined.") break;
	}
...
D3D12_RESOURCE_DIMENSION TextureTypeToD3D12(Mox::TEXTURE_TYPE InFormat)
{
	...
	case Mox::TEXTURE_TYPE::TEX_CUBE: return D3D12_RESOURCE_DIMENSION::D3D12_RESOURCE_DIMENSION_TEXTURE2D;
