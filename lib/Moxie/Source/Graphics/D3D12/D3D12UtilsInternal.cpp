...
DirectX::TEX_DIMENSION TextureTypeToD3D12(Mox::TEXTURE_TYPE InFormat)
{
	switch (InFormat)
	{
	case Mox::TEXTURE_TYPE::TEX_1D: return DirectX::TEX_DIMENSION::TEX_DIMENSION_TEXTURE1D;
	case Mox::TEXTURE_TYPE::TEX_2D: return DirectX::TEX_DIMENSION::TEX_DIMENSION_TEXTURE2D;
	case Mox::TEXTURE_TYPE::TEX_3D: return DirectX::TEX_DIMENSION::TEX_DIMENSION_TEXTURE3D;
...
Mox::TEXTURE_TYPE TextureTypeToEngine(DirectX::TEX_DIMENSION InFormat)
{
	switch (InFormat)
	{
		case DirectX::TEX_DIMENSION::TEX_DIMENSION_TEXTURE1D: return Mox::TEXTURE_TYPE::TEX_1D;
		case DirectX::TEX_DIMENSION::TEX_DIMENSION_TEXTURE2D: return Mox::TEXTURE_TYPE::TEX_2D;
		case DirectX::TEX_DIMENSION::TEX_DIMENSION_TEXTURE3D: return Mox::TEXTURE_TYPE::TEX_3D;
	default: StopForFail("Texture Format undefined.") break;
	}
