...
namespace Mox {
	...
	class D3D12Window : public Mox::Window
	{

	public:
		D3D12Window(const Mox::WindowInitInput& InWindowInitInput);
		...
		virtual Mox::CpuDescHandle& GetCurrentRTVDescriptorHandle() override;
	...
	private:
		...
		Mox::D3D12CpuDescriptorHandle CurrentRtvDescHandle;
		Mox::D3D12CpuDescriptorHandle CurrentDsvDescHandle;
	};
}
