...
public:
	...
	struct RESOURCE_BINDER_PARAM {
		...
		void InitAsConstants(uint32_t InNum32BitValues, uint32_t InShaderRegister, uint32_t InRegisterSpace = 0, Mox::SHADER_VISIBILITY InShaderVisibility = SHADER_VISIBILITY::SV_ALL)
		{
		...
		void InitAsTableCBVRange(uint32_t InNumDescriptors, uint32_t InShaderRegister, uint32_t InRegisterSpace = 0, Mox::SHADER_VISIBILITY InShaderVisibility = SHADER_VISIBILITY::SV_ALL)
		{
		...
		void InitAsTableSRVRange(uint32_t InNumDescriptors, uint32_t InShaderRegister, uint32_t InRegisterSpace = 0, Mox::SHADER_VISIBILITY InShaderVisibility = SHADER_VISIBILITY::SV_ALL)
		{
			NumDescriptors = InNumDescriptors;
			ShaderRegister = InShaderRegister;
			RegisterSpace = InRegisterSpace;
		...
		void InitAsTableUAVRange(uint32_t InNumDescriptors, uint32_t InShaderRegister, uint32_t InRegisterSpace = 0, Mox::SHADER_VISIBILITY InShaderVisibility = SHADER_VISIBILITY::SV_ALL)
		{
			NumDescriptors = InNumDescriptors;
			ShaderRegister = InShaderRegister;
			RegisterSpace = InRegisterSpace;
	...
	struct GRAPHICS_PSO_DESC {
		...
		Mox::PRIMITIVE_TOPOLOGY_TYPE TopologyType;
		Mox::Shader& VertexShader;
